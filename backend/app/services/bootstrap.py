...
def ensure_runtime_columns() -> None:
    column_specs = {
        ...
        "mini_program_users": {
            ...
            "checkin_warning_count": "INT NOT NULL DEFAULT 0",
            ...
            "checkin_permission_disabled_from": "DATETIME NULL",
            "checkin_permission_disabled_until": "DATETIME NULL",
