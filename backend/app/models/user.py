...
class MiniProgramUser(Base):
    ...
    checkin_risk_level = Column(String(16), default="normal", nullable=False)
    checkin_permission_disabled_from = Column(DateTime(timezone=True), nullable=True)
    checkin_permission_disabled_until = Column(DateTime(timezone=True), nullable=True)
...
class PassLevelSetting(Base):
    ...
    unlock_rule_zh = Column(String(1024), default="", nullable=False)
    unlock_rule_en = Column(String(1024), default="", nullable=False)
